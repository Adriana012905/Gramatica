package com.example.normalizacion.control;
...
import com.example.normalizacion.modelo.Palabra;
...
/*Se crea un  contructor el cual recibo los parametros de la gramatica a normalizar, los cuales son sus variables terminales
    ...
    y no terminales*/
    public Gramatica crearGramatica(String noTerminalesString, String terminalesString, String inicial, String sigamString){
